$.dk_tw_citySelector = { version: "0.0.1", debug: !0, log: function() {} },
    function($) { "use strict";
        $.fn.dk_tw_citySelector = function(t, e, o) {
            ...
            var i = ["基隆市", "台北市", "新北市", "桃園市", "新竹市", "新竹縣", "苗栗縣", "台中市", "彰化縣", "南投縣", "雲林縣", "嘉義市", "嘉義縣", "台南市", "高雄市", "屏東縣", "台東縣", "花蓮縣", "宜蘭縣", "澎湖縣", "金門縣", "連江縣"],
                r = [
                    [
                    ...
                    [
                        ["萬里區", "金山區", "板橋區", "汐止區", "深坑區", "石碇區", "瑞芳區", "平溪區", "雙溪區", "貢寮區", "新店區", "坪林區", "烏來區", "永和區", "中和區", "土城區", "三峽鎮", "樹林區", "鶯歌鎮", "三重區", "新莊區", "泰山區", "林口區", "蘆洲區", "五股區", "八里區", "淡水鎮", "三芝區", "石門區"],
                    ...
                    [
                        ["台東市", "綠島鄉", "蘭嶼鄉", "延平鄉", "卑南鄉", "鹿野鄉", "關山鎮", "海端鄉", "池上鄉", "東河鄉", "成功鎮", "長濱鄉", "太麻里鄉", "金峰鄉", "大武鄉", "達仁鄉"],
                ...
                c = $(e, a),
                d = $(o, a),
                s = '<option value="">不限</option>',
                l = '<option value="">不限</option>',
                u = p.data("custom");
